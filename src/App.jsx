...
const App = () => {
  ...
  const [settings, setSettings] = useState({
    preferredSearchEngine:
      localStorage.getItem("preferredSearchEngine") ||
      defaultSettings.preferredSearchEngine,
    otherSetting:
      localStorage.getItem("otherSetting") || defaultSettings.otherSetting,
  });

  useEffect(() => {
    localStorage.setItem(
      "preferredSearchEngine",
      settings.preferredSearchEngine
    );
  ...
  return (
    <div className="app-main-body">
      ...
      <DataGrid
        preferredSearchEngine={settings.preferredSearchEngine}
